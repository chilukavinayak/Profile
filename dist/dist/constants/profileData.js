...
export const PROFILE_DATA = {
  ...
  summary: {
    headline: "Principal Software Engineer with 9+ years architecting large-scale distributed systems on AWS, specializing in microservices, cloud modernization, and secure platform engineering.",
    highlights: [
      "Architected and operated platforms handling 10,000+ RPS with 99.99% availability",
      "Delivered 25-30% infrastructure cost savings ($XXXK+ annual) through optimization and reserved capacity",
      "Led zero-downtime migrations and security hardening for 50+ production databases",
      "Established cross-team engineering standards for observability and CI/CD",
      "Mentored engineering leaders and scaled platforms across 15+ countries"
    ],
    techPhilosophy: "Design for reliability, measurable business impact, and developer productivity"
  },

  leadership: {
    summary: "Technical strategy, architecture roadmaps, and cross-functional leadership across platform and product teams.",
    scope: "Influenced 60+ internal applications, mentored 10+ engineers, and led architecture reviews across multiple business units."
  },

  coreCompetencies: [
    "Technical Strategy & Roadmaps",
    "System Design & Architecture Patterns (Event-driven, CQRS, Sagas)",
