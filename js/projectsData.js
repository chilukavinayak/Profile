...
export const PROJECTS_DATA = [
  ...
  {
    id: 9,
    title: "Medical Diagnosis RAG Chatbot",
    description: "RAG-enabled medical diagnosis assistant combining clinical knowledge bases with LLM reasoning for accurate, auditable recommendations.",
    longDescription: "Built a retrieval-augmented generation (RAG) medical assistant that combines a curated clinical knowledge base and patient records with LLM reasoning. Uses vector search for relevant context, prompt templates for safe responses, and an explainability layer for audit and compliance.",
    category: "ai",
    featured: true,
    technologies: ["Python", "FastAPI", "LangChain", "OpenAI/LLM", "FAISS", "PostgreSQL", "Docker", "Kubernetes"],
    metrics: {
      retrievalPrecision: "92%",
      avgResponseTime: "400ms",
      clinicalCoverage: "Primary care + cardiology",
      latency: "< 500ms",
      users: "Pilot: 500 clinicians"
    },
    achievements: [
      "Implemented RAG pipeline using FAISS for vector retrieval",
      "Added explainability snippets for each response to improve clinical trust",
      "Integrated with hospital EHR sandbox for secure record retrieval",
      "Achieved 92% retrieval precision on validation benchmarks"
    ],
    architecture: {
      retriever: "FAISS + pgvector",
      llm: "OpenAI / hosted LLM",
      api: "FastAPI",
      storage: "PostgreSQL (patient metadata) + S3 (documents)",
      orchestration: "Kubernetes"
    },
    githubUrl: "https://github.com/chilukavinayak/medical-diagnosis-rag",
    liveUrl: ""
  },

  {
    id: 10,
    title: "Realtime Voice AI Agent with RAG",
    description: "Realtime voice assistant that transcribes user audio, retrieves contextual documents, and composes grounded voice responses using RAG and TTS.",
    longDescription: "A realtime voice AI agent that captures audio via WebRTC, uses Whisper/streaming ASR for transcription, performs vector search for context, and generates grounded answers synthesized back to speech. Designed for low-latency interactions and multi-turn conversations.",
    category: "ai",
    featured: true,
    technologies: ["WebRTC", "Whisper/ASR", "LangChain", "Weaviate", "Redis", "Docker", "Kubernetes", "gRPC"],
    metrics: {
      rtt: "< 700ms (median)",
      concurrency: "200 concurrent sessions",
      retrievalRecall: "90%",
      ttsLatency: "300ms",
      availability: "99.9%"
    },
    achievements: [
      "Built a streaming RAG pipeline for sub-second voice interactions",
      "Scaled to 200 concurrent users with autoscaling WebRTC gateways",
      "Implemented context windowing for multi-turn coherence",
      "Reduced hallucinations by grounding responses with retrieved docs"
    ],
    architecture: {
      ingestion: "WebRTC → ASR (Whisper)",
      retriever: "Weaviate vector DB",
      llm: "Streaming LLM for partial responses",
      tts: "Neural TTS service",
      state: "Redis (session state)"
    },
    githubUrl: "https://github.com/chilukavinayak/realtime-voice-rag",
    liveUrl: ""
  },

  {
    id: 11,
    title: "AI-Powered Text-to-SQL RAG Chatbot",
    description: "Text-to-SQL assistant that uses RAG to fetch schema-aware examples and synthesizes secure SQL for analytics queries.",
    longDescription: "An assistant that converts natural language questions into safe, optimized SQL using RAG to retrieve schema docs, sample queries, and business glossary terms. Includes a query sandbox and SQL linting to prevent unsafe operations.",
    category: "ai",
    featured: true,
    technologies: ["Python", "FastAPI", "LangChain", "OpenAI/LLM", "pgvector", "PostgreSQL", "Docker"],
    metrics: {
      queryAccuracy: "88%",
      avgLatency: "350ms",
      preventedUnsafeQueries: "100% (sandbox enforced)",
      adoption: "Data team pilot: 40 users"
    },
    achievements: [
      "Implemented schema-aware retrieval to reduce SQL errors",
      "Built a query sandbox to prevent destructive statements",
      "Deployed pgvector for fast schema and example retrieval",
      "Reduced analyst time-to-insight by 3x"
    ],
    architecture: {
      retriever: "pgvector on Postgres",
      llm: "OpenAI / hosted LLM",
      api: "FastAPI",
      security: "Query sandbox + SQL linting",
      persistence: "Postgres"
    },
    githubUrl: "https://github.com/chilukavinayak/text-to-sql-rag",
    liveUrl: ""
  },

  {
    id: 12,
    title: "Air India RAG Chatbot Development",
    description: "RAG-based conversational assistant for airline customer support, integrating knowledge bases, policy docs, and flight data for accurate, auditable responses.",
    longDescription: "Developed a RAG-powered chatbot prototype for airline customer support that combines policy documents, FAQs, and flight status data to generate grounded answers. Focused on compliance, multi-language support, and escalation handoffs.",
    category: "ai",
    featured: false,
    technologies: ["Python", "FastAPI", "LangChain", "OpenSearch/Elastic", "OpenAI/LLM", "Docker", "Kubernetes"],
    metrics: {
      csrReduction: "45%",
      multilingualSupport: "EN/HI/TE",
      retrievalPrecision: "90%",
      escalationRate: "5%",
      latency: "< 500ms"
    },
    achievements: [
      "Integrated flight status APIs for live grounding of answers",
      "Added multilingual retrieval and response templates",
      "Created escalation flows for policy-sensitive queries",
      "Reduced average handling time for common queries by 45%"
    ],
    architecture: {
      retriever: "OpenSearch + embeddings",
      llm: "Hosted LLM",
      api: "FastAPI",
      docs: "S3 + OpenSearch index",
      orchestration: "Kubernetes"
    },
    githubUrl: "https://github.com/chilukavinayak/airline-rag-chatbot",
    liveUrl: ""
  }
];
...
export const PROJECT_CATEGORIES = [
  ...
  { id: 'ai', name: 'AI & RAG Applications', count: PROJECTS_DATA.filter(p => p.category === 'ai').length }
];
